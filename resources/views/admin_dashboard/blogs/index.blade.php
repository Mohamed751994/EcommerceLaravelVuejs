        ...
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-auto position-relative">
                    <a href="{{route('blogs.create')}}" class="btnIcon btn btn-outline-primary px-5"><i class="lni lni-circle-plus"></i> إنشاء جديد </a>
                </div>
            </div>
                ...
                <table class="table align-middle table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$con->title}}</td>
                            <td>
                                <span class="badge bg-light-primary text-primary">{{date('d/m/Y', strtotime($con->created_at))}}</span>
                            </td>
                            <td>
                                <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                    <a href="{{route('blogs.edit', $con->id)}}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{route('blogs.destroy',$con->id)}}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
