...
<head>
    ...
    <title>مصنع نما طيبة | تسجيل الدخول</title>
</head>
        ...
        <div class="container-fluid">
            <div class="authentication-card">
                ...
                <div class="card shadow rounded-0 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-lg-6 bg-nama d-flex align-items-center justify-content-center">
                            <img src="{{asset('frontend/img/nama/logo.png')}}" class="img-fluid" alt="">
                        </div>
                        <div class="col-lg-6">
                            <div class="card-body p-4 p-sm-5">

                                <h5 class="card-title my-3 text-center">  مصنع نما طيبة | تسجيل الدخول  </h5>
