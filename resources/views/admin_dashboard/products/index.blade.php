    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <h5 class="mb-0"> <i class="bi bi-grid-fill"></i>  المنتجات </h5>
                <div class="ms-auto position-relative">
                    <a href="{{route('products.create')}}" class="btnIcon btn btn-outline-primary px-5"><i class="lni lni-circle-plus"></i> إنشاء جديد </a>
                </div>
            </div>
                ...
                <table class="table align-middle table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$con->name}} - <strong>({{$con->size}})</strong></td>
                            <td>
                                <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                    <a href="{{route('products.edit', $con->id)}}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{route('products.destroy',$con->id)}}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
