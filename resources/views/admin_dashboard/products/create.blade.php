...
@section('Page_Title')   المنتجات | إضافة   @endsection
                                ...
                                <div class="card-body">
                                    ...
                                    action="{{route('products.store')}}">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="size" class="form-control" required placeholder="ادخل المقاس">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label"> عنوان رابط الصفحة ( Slug )  <span class="text-danger">*</span>  </label>
                                            <input type="text" name="slug" class="form-control" required placeholder="ادخل عنوان رابط الصفحة">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">  سعر الحبة (ر.س) <span class="text-danger">*</span> </label>
                                            <input type="number" min="0" name="price" class="form-control" required placeholder="ادخل سعر العنصر">
                                        </div>
